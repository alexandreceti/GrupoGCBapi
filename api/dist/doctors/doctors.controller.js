...
const doctor_pipe_1 = require("./doctor.pipe");
...
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UsePipes)(new doctor_pipe_1.YupValidationPipe(create_doctor_dto_1.CreateDoctorSchema)),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_1.UsePipes)(new doctor_pipe_1.YupValidationPipe(update_doctor_dto_1.UpdateDoctorSchema)),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
